...
|-----|-------------------------------------|-----------------------------------------------------------------------------|
| 1   | [flights dbt_project](./flights_dbt_project)                           | (Analytics engineering project built on real flight data using dbt and PostgreSQL, covering the full workflow: raw source ingestion, staging, and marts — with tests and documentation at every layer)                                                 |
